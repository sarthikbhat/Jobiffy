...
class Classifier:
    ...
    def __init__(self):
        ...
        self.final_database2 = self.final_database['Keyword'].groupby(
            [self.final_database['Candidate Name'], self.final_database['Subject']]).count().unstack()
    ...
    def create_profile(self, file):
        ...
        dataf = pd.concat(
            [name3['Candidate Name'], df3['Subject'], df3['Keyword'], df3['Count']], axis=1)
